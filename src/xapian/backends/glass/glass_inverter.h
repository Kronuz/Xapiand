...
class Inverter {
    ...
    btree::map<std::string, btree::map<Xapian::docid, std::string>> pos_changes;
  ...
  public:
    ...
    btree::map<Xapian::docid, Xapian::termcount> doclen_changes;
  ...
  public:
	...
	btree::map<Xapian::docid, Xapian::termcount>::const_iterator i;
