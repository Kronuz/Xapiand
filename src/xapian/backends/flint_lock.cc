...
retry:
    ...
    // available.  Support was added in Linux 3.15 and was standardised in
    // POSIX issue 8 so hopefully will be available for all POSIX platforms
    // with time.  So far it seems they've also been implemented for macOS.
