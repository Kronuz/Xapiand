...
The index's [`:info`]({{ '/docs/reference-guide/indices' | relative_url }})
...
[Remote protocol]({{ '/docs/reference-guide/indices' | relative_url }}) that
...
[write-ahead log]({{ '/docs/reference-guide/wal' | relative_url }}) to apply the
...
a cluster. See [Clustering]({{ '/docs/clustering' | relative_url }}) for how
