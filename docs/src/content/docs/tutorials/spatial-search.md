...
You can download the [sample dataset](/Xapiand/assets/cities.ndjson).
...
![El Cerrito, CA](/Xapiand/assets/el_cerrito.png)
...
See [Hierarchical Triangular Mesh](/Xapiand/reference-guide/schemas/field-types/geospatial-type/htm)
