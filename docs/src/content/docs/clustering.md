...
![A single-node cluster with an index](/Xapiand/assets/cluster2.png)
...
![A two-node cluster with all primary and replica shards allocated](/Xapiand/assets/cluster3.png)
...
![A three-node cluster with shards reallocated to spread the load](/Xapiand/assets/cluster4.png)
...
![Increasing the number of replicas to 2](/Xapiand/assets/cluster5.png)

:::hint[You need to add hardware to increase throughput]{.info}
...
![Cluster after killing node one](/Xapiand/assets/cluster6.png)
...
![Cluster after restarting node one](/Xapiand/assets/cluster7.png)
