...
For the curious, this data was generated using [Faker](https://faker.readthedocs.io),
using the [generator.py](/Xapiand/assets/generator.py)
script, so please ignore the actual values and semantics of the data as these
are all randomly generated.

## Loading the Sample Dataset

After downloading the [sample dataset](/Xapiand/assets/accounts.ndjson),
...
<!-- e2e:begin
---
description: Search ordered by accountNumber
---
...
<!-- e2e:begin
---
description: Search ordered by balance
---
...
<!-- e2e:begin
---
description: Search filtered balance
---
...
The [Aggregations Reference Guide](/Xapiand/reference-guide/search/aggregations)
