...
Note you _**must**_ provide [convex polygons](https://en.wikipedia.org/wiki/Convex_polygon); at the moment, [concave polygons](https://en.wikipedia.org/wiki/Concave_polygon)
are not supported.
:::
...
[Graham Scan Algorithm](https://en.wikipedia.org/wiki/Graham_scan#Algorithm):
